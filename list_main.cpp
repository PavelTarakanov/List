...
int main(int argc, char* argv[])
{
    ...
    list_insert(&list, 45, 3, argv[1], html_dump_address);
    list_delete(&list, 2, argv[1], html_dump_address);
...
int list_dump(list_t* list, char* dump_file_name, FILE* html_dump_address)
{
    ...
    char* str_dump_number = (char*) calloc(MAX_COMMAND_SIZE, sizeof(char));
